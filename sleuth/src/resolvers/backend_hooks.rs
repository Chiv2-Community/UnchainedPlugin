...
use patternsleuth::{resolvers::{ensure_one, impl_resolver_singleton, try_ensure_one, unreal::util::{self, Call}, Result}, MemoryTrait};
...
// define_process!(PreLogin, xrefLast, {
...
// ) -> patternsleuth::resolvers::Result<PreLogin> {
...
//         }
//     }
//     Ok(PreLogin(ensure_one(result)?))
// }
macro_rules! xrefLast {
    (@emit_body $name:ident) => {
